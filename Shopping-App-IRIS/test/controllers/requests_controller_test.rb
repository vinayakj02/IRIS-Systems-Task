...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { category: @request.category, description: @request.description } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { category: @request.category, description: @request.description } }
